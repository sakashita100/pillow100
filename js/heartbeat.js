...
var data = "80,80,80,90,91,92,93,94,95,96,97,98,99,100,101,102," ;
const bpms =　data.split(',').map( str => parseInt(str, 10) );   //xmlHttp.responseText);  // <-- ?
//const bpms = [90,91,92,93,94,95,96,97,98,99,100,101,102,];
